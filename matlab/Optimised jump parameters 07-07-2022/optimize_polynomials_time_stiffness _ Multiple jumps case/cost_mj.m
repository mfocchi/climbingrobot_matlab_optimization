function coste = cost_mj(x, p0,  pf)

    global m w1 w2 w3 w4 w5 N num_params x_vec0  x_vecf y_vec0  y_vecf z_vec0  z_vecf k
    ...
    p_f = p(:,end);
    l_f = l(end);
%     l_f = sqrt(x_vecf(k)^2 +y_vecf(k)^2 +z_vecf(k)^2);
