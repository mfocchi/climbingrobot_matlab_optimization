...
void xgeqp3(emxArray_real_T *A, int32_T b_m, int32_T n, emxArray_int32_T *jpvt,
            emxArray_real_T *tau)
{
  ptrdiff_t info_t;
  ...
  if (n < 1) {
    ...
    info_t = LAPACKE_dgeqp3(102, (ptrdiff_t)b_m, (ptrdiff_t)n, &A->data[0],
    ...
    if ((int32_T)info_t != 0) {
      ...
      na = muIntScalarMin_sint32(b_m, n) - 1;
      for (ma = 0; ma <= na; ma++) {
        tau->data[ma] = rtNaN;
      }
