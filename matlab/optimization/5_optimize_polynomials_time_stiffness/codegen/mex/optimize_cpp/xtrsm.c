...
void b_xtrsm(int32_T b_m, const emxArray_real_T *A, int32_T lda, emxArray_real_T
             *B, int32_T ldb)
{
  ptrdiff_t lda_t;
  ptrdiff_t ldb_t;
...
void xtrsm(int32_T b_m, const emxArray_real_T *A, int32_T lda, emxArray_real_T
           *B, int32_T ldb)
{
  ptrdiff_t lda_t;
  ptrdiff_t ldb_t;
