             ...
             *output_lssteplength, real_T *output_firstorderopt)
{
  ...
  anon(nonlcon_tunableEnvironment_f1, nonlcon_tunableEnvironment_f2,
       ...
       nonlcon_tunableEnvironment_f5, x0, r);
  ...
  FcnEvaluator.objfun.tunableEnvironment[1] = fun_tunableEnvironment[1];
  ...
  b_factoryConstruct(fun_tunableEnvironment, nonlcon_tunableEnvironment_f1,
                     nonlcon_tunableEnvironment_f2,
                     nonlcon_tunableEnvironment_f3,
                     nonlcon_tunableEnvironment_f4,
                     nonlcon_tunableEnvironment_f5, x0->size[1], r->size[1], ub,
                     &FiniteDifferences);
  ...
  for (maxDims = 0; maxDims <= nVar; maxDims++) {
    ...
    {
      if (muDoubleScalarAbs(normResid - ub->data[maxDims]) < 0.0001) {
        Cineq_size_idx_1++;
  ...
  *fval = b_anon(TrialState.xstarsqp);
  idxFillStart = 1;
  ...
  if (idxFillStart == 1) {
    computeConstraints_(FcnEvaluator.nonlcon.tunableEnvironment.f1,
                        ...
                        nonlcon_tunableEnvironment_f3,
                        nonlcon_tunableEnvironment_f4,
                        nonlcon_tunableEnvironment_f5, r->size[1],
