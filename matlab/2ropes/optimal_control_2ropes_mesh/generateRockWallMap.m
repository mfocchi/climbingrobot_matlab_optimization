function [X, Y, Z] = generateRockWallMapComplex(Lz, Ly, gridSize,wallHeight, seed, debug)
...
% 
% Fractal noise / multi-scale Perlin-like structures for roughness.
% 
% Ridges / dihedrals with directional high gradients.
% 
% Random extrusions for pillars or bulges.
...
% Vertical ridge
X(:, round(gridSize*0.3):15 +round(gridSize*0.3)) =X(:, round(gridSize*0.3):15 + round(gridSize*0.3)) + 3.5;
...
for i = 1:numPillars
    ...
    X = X + bulge * wallHeight;  % bump height
end
