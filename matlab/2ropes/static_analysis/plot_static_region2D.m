function a = plot_static_region2D(x_vec, y_vec, z_vec, mu, colormap_vector , label, colorbar_limits)
    ...
    % plot only right side
    h = scatter3(zeros(1, length(y_vec)),y_vec,z_vec, 150, colormap_vector,'filled');hold on ;
    view(90, 0)
...
%     a.FontSize =40;
    ...
    line([p_anchor2(1) p_anchor2(1)],[p_anchor2(2) p_anchor2(2)],[p_anchor2(3) -10], 'color','k','linewidth',2);grid on;hold on;
    % plot right anchor   
