...
l_range_dense = [l_range(1):0.05:l_range(end)];
thetaf_range_dense = [thetaf_range(1):0.01:thetaf_range(end)];
...
plot_surf("energy",l_range_dense, thetaf_range_dense, lthetaf_vector(1,:) ,   lthetaf_vector(2,:),    energy_consumption);
