...
The Table shows that a  good trade-off can be found between accuracy and computation time that enables real-time implementations.
In Fig. \ref{fig:validation}  we report the results of the validation. 
The matching is almost perfect   (apart form drifts in the integration) in the case of Matlab and inside to the approximation
