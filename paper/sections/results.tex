	...
	\resizebox{\columnwidth}{!}{
		\begin{tabular}{l c c  } \hline\hline
			\textbf{Name} \quad & \textbf{Symbol}           & \textbf{Value}  \\ \hline
					...
					Max. retraction force [N] & $F_{r,nax}$			& 200    \\
					Friction coeff.		& $ \mu $ 					& 0.8   \\
					Thrust impulse duration	& 	$T_{th}$  				& 0.025\\
...
For the Gazebo simulation we actuate the rope joint with the $F_r$ force pattern and map the contact force into the efforts at the leg joints 
as follows:
