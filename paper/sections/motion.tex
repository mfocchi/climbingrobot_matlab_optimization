...
assumed to be a $\mathcal{C}_\infty$ function. In absence of obstacles this constraint it boils down to prevent the trajectory from penetrating the wall (i.e. $X >0$).
We also want to set a limit on the fact the robot elevation should not go beyond the anchor level (i.e. $Z<0$).
