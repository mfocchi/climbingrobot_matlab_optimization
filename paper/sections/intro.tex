...
adhesion technique \cite{longo2008} used to attach the robot to the wall surface, 
and locomotion mechanism \cite{Chu2010}, utilized for climbing.
These attachment and moving methods are basically considered as the main problems 
to be solved in designing climbing robots. Other requirements may also be requested 
depending on the desired application, like (R1) to move safely, and (R2) fast in emergency 
situations, (R3) ability to carry a payload, and (R4) avoid obstacles \cite{Schmidt2013}.
