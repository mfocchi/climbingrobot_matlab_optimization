...
respectively, according to the adhesion technique \cite{longo2008}
used to attach the robot to the wall surface, and locomotion mechanism
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.6\columnwidth]{figs/3dmodel.pdf}
...
%
In this work, we present a novel robotic platform called CLIO
