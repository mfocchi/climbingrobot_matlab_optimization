...
missions in mountain environments such as Canyons, lunar craters. 
This could be employed in civil applications in scaling maintenance activity, e.g., to detach from the
...
% limitations
The main limitations of the actual work is the limited \textit{reachability} with 
the single anchor arrangement and the lack of descriptiveness (in terms of angular dynamics) of the simplified model.
This prevents to devise planning strategy that optimize also the orientation of the robot at the landing. 
...
and to secure the proper alignment of the leg  to guarantee a safe landing.  
Last, we are working on the design of a landing controller to dissipate the landing kinetic energy avoiding rebounces. All these steps are preparatory to the development of a working prototype.
